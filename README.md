...
| 你看到的词 | 它在说什么 | 什么时候消失 |
| --- | --- | --- |
| **待你决断**（失败时写「失败待决断」） | 这张卡在「待审核」列，有已经跑完、但你**还没看过**的结果 | 你点开看过（卡片或会话），或者点「通过 / 打回」 |
| **等你处理 N 项**（板顶那行） | 有 N 个会话正挂起等你回答（权限审批 / 计划确认 / 提问） | 你在那个会话里回答完 |
| **待审核 M 张**（板顶那行） | 有 M 张卡在「待审核」列，且成果还没被你看过 | 同「待你决断」 |
| **新 N / 新留言** | 这张卡（或这些会话）有还没看过的**新内容** | 打开卡片或会话即消失 |
...
- **「待你决断」和「新 N」是两件事**。「新」是「你还没看」，「待你决断」是「你还没看**也**
  还没裁决」。所以点开看过之后，「新 N」和「待你决断」会一起消失，但卡片仍然待在「待审核」
  列里——那是你自己决定它什么时候走。
