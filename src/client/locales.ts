...
export const zh = {
  ...
  'detail.schedule.paused.failed': '任务处于已失败，自动执行已暂停：点「重新执行」立即恢复，或移到待办后按计划继续。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'detail.schedule.paused.failed': 'The task failed, so auto-run is paused: hit "Run Again" to resume now, or move it to To Do to continue on schedule.',
